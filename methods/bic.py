...
class BiC(BaseLearner):
    ...
    def prepare_model(self):
        if self._network == None:
            self._network = IncrementalNetWithBias(self._config.backbone, self._config.pretrained, bias_correction=True)
    ...
    def prepare_task_data(self, data_manager):
        ...
        if self._cur_task > 0:
            ...
            logging.info('Stage1 dset: {}, Stage2 dset: {}'.format(len(train_dataset), len(val_dataset)))
    ...
    def _stage1_training(self, model, train_loader, test_loader):
        ...
        if self._cur_task == 0:
            ...
            return
        '''
        logging.info('-'*10 + ' training stage 1 ' + '-'*10)
    ...
    def _stage2_bias_correction(self, model, val_loader, test_loader):
        logging.info('-'*10 + ' training stage 2 ' + '-'*10)
